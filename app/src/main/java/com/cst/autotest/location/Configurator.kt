...
class Configurator {
    ...
    /*inner*/ class GetWaitForIdleTimeout(private val parent: com.cst.autotest.location.Configurator = Configurator()) {
    ...
    /*inner*/ class SetWaitForIdleTimeout(
        ...
        private val parent: com.cst.autotest.location.Configurator = Configurator()
    ) {
